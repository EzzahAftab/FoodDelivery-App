            ...
            if (doc.exists) {
                ...
                if (Array.isArray(cartItems)) {
                    ...
                    if (existingItemIndex !== -1) {
                        ...
                        const updatedQuantity = existingItem.FoodQuantity + parseInt(quantity, 10);
                        const updateditem = {
                            ...existingItem,
                            FoodQuantity: updatedQuantity,
                        totalFoodPrice: parseInt(data.FoodPrice) * updatedQuantity,
                        };
            ...
            <View style={styles.containerIn}>
                ...
                <View style={styles.containerIn2}>
                    ...
                    <View style={styles.containerIn2_s2}>
                        ...
                        <Text style={styles.containerIn2_s2_description}>{data.About}</Text>
                    ...
                    <View style={styles.containerIn2_s3}>
                        <Text style={styles.containerIn2_s3_restaurantnameheading}>Cheezious Restaurant</Text>
